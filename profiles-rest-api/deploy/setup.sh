...
PROJECT_GIT_URL='https://github.com/jppradoleal/django-rest-course.git'

PROJECT_BASE_PATH='/usr/local/apps/django-rest-course'
...
$PROJECT_BASE_PATH/env/bin/pip install -r $PROJECT_BASE_PATH/profiles-rest-api/requirements.txt
